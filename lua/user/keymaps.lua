...
vim.cmd [[ command! -nargs=1 Include  call feedkeys("mZ") | call timer_start(1, { tid -> execute('6r /home/irfan/cp/.utils/library/<args>.cpp')}) | call timer_start(1, { tid -> execute('call feedkeys("`Z")')}) ]]
